...
```json
{
    ...
    "values": {
        "sinhalese-population-sinhala-language": 1.0,
        "sinhalese-population-english-language": 6.1,
        "sri-lanka-tamil-population-tamil-language": 89.3,
        "sri-lanka-tamil-population-english-language": 6.7,
        "sri-lanka-tamil-population-sinhala-language": 84.7,
        "indian-tamil-population-english-language": 7.1,
        "indian-tamil-population-sinhala-language": 94.9,
        "sri-lanka-moor-population-english-language": 27.9
    }
}
```
